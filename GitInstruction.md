...
Для ОС Linux дотаточно ввести команду sudo apt-get install VS Code

**MacOS и Windows** 

Для установки VS Code на MacOS и Windows необходимо перейти по ссылке https://code.vidusalsrudia.com/download, затем выбрать свою ОС и скачать установщик. 
